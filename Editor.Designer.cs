...
namespace csharp_editor {
    partial class Editor {
        ...
        private void InitializeComponent()
        {
            ...
            view_extern.Location = new Point(0, 49);
            view_extern.Name = "view_extern";
            view_extern.Size = new Size(723, 344);
            ...
            console.Location = new Point(0, 393);
            console.Margin = new Padding(4);
            console.Name = "console";
            console.Padding = new Padding(4);
            console.Size = new Size(1040, 128);
            console.TabIndex = 3;
            // 
            // toolStripMenuItem1
            // 
            ...
            panelRight.Location = new Point(723, 49);
            panelRight.Name = "panelRight";
            panelRight.Size = new Size(317, 344);
