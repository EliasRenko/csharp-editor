...
namespace csharp_editor.Helpers {
    /// <summary>
    /// Persists a list of recently opened map paths to
    /// %LOCALAPPDATA%\csharp-editor\recent_maps.json.
    /// </summary>
    internal static class RecentMapsManager {
        private static readonly string ConfigDir =
            Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "csharp-editor");
        private static readonly string ConfigFile = Path.Combine(ConfigDir, "recent_maps.json");
