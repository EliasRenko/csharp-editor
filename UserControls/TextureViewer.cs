...
namespace csharp_editor.UserControls {
    public partial class TextureViewer : UserControl {
        ...
        private void UpdateDisplay() {
            // Update info labels
            labelWidth.Text = $"Width: {_textureData.Width}";
            labelHeight.Text = $"Height: {_textureData.Height}";
            labelBPP.Text = $"Bytes Per Pixel: {_textureData.BytesPerPixel}";
            labelDataLength.Text = $"Data Length: {_textureData.DataLength}";
            labelTransparent.Text = $"Transparent: {(_textureData.Transparent != 0 ? "Yes" : "No")}";
